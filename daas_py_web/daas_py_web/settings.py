"""
Django settings for daas_py_web project.
...
SECRET_KEY = 'django-insecure-c(6=sw66!79rgyo7%x+(i%0(@-kbqy+m@=fjjw*3u)4ezbox&k'
...
WSGI_APPLICATION = 'daas_py_web.wsgi.application'
